...
// 乙／己／庚／辛／癸五干核對一致；甲、戊兩干原值錯誤，已用實測結果改正；
// 丙、壬兩干原值其實是「學堂貴人」的值（見下面 XUE_TANG_REAL），天廚貴人在這兩干的正確值還沒確認，
// 暫時拿掉（不顯示）避免掛錯名字；丁干尚未有足夠測試資料確認，先保留原值。
const TIAN_CHU = { 甲: "巳", 乙: "午", 丁: "酉", 戊: "申", 己: "酉", 庚: "巳", 辛: "子", 癸: "卯" };
// 真正的學堂貴人：目前只實測確認了 6 個天干（丙／丁／戊／己／辛／壬），其餘（甲／乙／庚／癸）尚未確認，
// 資料不足以前不加進去，避免顯示錯誤內容，見 README 已知限制
const XUE_TANG_REAL = { 丙: "寅", 丁: "寅", 戊: "申", 己: "申", 辛: "巳", 壬: "申" };
