...
// 原本誤標成「學堂貴人」，實測比對參考網站後確認這組數值對應的是天廚貴人（乙／己／辛／癸四干逐一核對一致；
// 丙干核對後發現參考網站在丙干這格顯示的其實是學堂貴人而非天廚，代表丙這格的天廚貴人正確值還沒確認，
// 暫時保留原值，真正的學堂貴人／金匱貴人／詞館貴人目前尚未實作，見 README 已知限制）
const TIAN_CHU = { 甲: "亥", 乙: "午", 丙: "寅", 丁: "酉", 戊: "寅", 己: "酉", 庚: "巳", 辛: "子", 壬: "申", 癸: "卯" };
...
const BING_FU = { 子: "亥", 丑: "子", 寅: "丑", 卯: "寅", 辰: "卯", 巳: "辰", 午: "巳", 未: "午", 申: "未", 酉: "申", 戌: "酉", 亥: "戌" };
