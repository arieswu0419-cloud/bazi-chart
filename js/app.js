...
const JIU_DUN_RULES = [
  ...
  // 地遁＝乙＋開門＋地盤己（古法「開門六乙合六己」），不限宮、不限神——2026-07 官網 4 筆定案：
  // 07-18 19:17 巽4（乙/己/開）顯示「風遁＋地遁」、07-19 23:17 兌7「地遁＋真詐」、
  // 07-24 15:17 離9「地遁＋休詐」皆有地遁；先前 2029 舊筆記「巽4 無地遁」與 07-18 實測矛盾，
  // 判定舊記錄有誤，排除規則撤銷
  { name: "地遁", tianGan: "乙", men: "開", diGan: "己" }
  // 虎遁：判定官網「沒有實作」，維持不標＝行為一致（2026-07/08 六筆負樣本、零正例）：
  //   乙+三吉門+艮8（08-19 艮8 乙/辛/開→只有雲遁）；天盤辛+生門 全家族——
  //   艮8 辛/辛/生+九地（08-07）、艮8 辛/辛/生+九天（08-18）、乾6 辛/壬/生+六合（07-25，
  //   連古法「生門六辛合六合」變體一併否證）、離9 辛/己/生+六合（07-26）全部無虎遁。
];
